...
import { DashboardContainer, ProfileButton, ProfileSection, ProfileTitle } from "../components/styledComponents";
...
const AdminProfile = () => {
    ...
    return (
        <DashboardContainer>
            <ProfileSection>
                <ProfileTitle>Create New User</ProfileTitle>
                <FormCard>
                    ...
                    {message && <p style={{ textAlign: "center", color: "#6c5ce7" }}>{message}</p>}
                </FormCard>
            </ProfileSection>

            <ProfileSection>
                <ProfileTitle>Existing Users</ProfileTitle>
                <TableContainer>
                    <UserTable>
                        <thead>
                            <tr>
                            ...
                            {users.map(u => (
                                <tr key={u._id}>
                                    ...
                                    <td>
                                        {editId === u._id ? (
                                            <>
                                                <ActionButton onClick={() => handleEditSave(u._id)} color="#6c5ce7">Save</ActionButton>
                                                <ActionButton onClick={handleEditCancel} color="#888">Cancel</ActionButton>
                                            </>
                                        ) : (
                                            <>
                                                <ActionButton onClick={() => handleEdit(u)} color="#6c5ce7">Edit</ActionButton>
                                                <ActionButton onClick={() => handleDelete(u._id)} color="#dc3545">Delete</ActionButton>
                                            </>
                                        )}
                                    </td>
                                </tr>
